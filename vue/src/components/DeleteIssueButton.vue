<template>
  <div id="deleteButton">
    ...
    <b-button v-if="$store.state.token != ''" style="vertical-align: middle; min-width:100%; max-height:40px; margin-bottom:10px" variant="danger" v-on:click="deleteOnClick" v-show="isMine">Delete</b-button>
  </div>
</template>
