    ...
    <b-container id="issue-data">
      <b-row>
        <b-col class="text-left">
          <h1 class="title" style="font-family: bebas neue">
            {{ issue.seriesTitle }}
          </h1>
          <br />
          <p class="data">
            <b class="bold"> Issue No:</b> {{ issue.issueNumber }}
          </p>
          <p class="data"><b class="bold">Creator:</b> {{ issue.creator }}</p>
          <p class="data">
            <b class="bold"> Publisher:</b> {{ issue.publisher }}
          </p>
          <p class="data">
            <b class="bold">Publication Date:</b> {{ issue.releaseDate }}
          </p>
          <p class="data">
            <b class="bold">Page Count:</b> {{ issue.pageCount }}
          </p>
          <p class="data">
            <b class="bold">Featuring: </b>{{ issue.characters }}
          </p>
          <br />
          <h3 v-if="$store.state.token != ''" style="font-family: bebas neue">
            Add to collection:
          </h3>
          <h3 v-if="$store.state.token == ''" style="font-family: bebas neue">
            ...
            <b-row v-if="$store.state.token != ''">
              <b-col
                ><b-button
                  ...
                  >{{ unaddedCollection.name }}</b-button
                ></b-col
              >
            </b-row>
            <b-row>
        ...
        <b-col class="text-right">
          <img
            v-if="issue.coverLink != ''"
            :src="issue.coverLink"
            style="max-width: 400px" />
          <div v-else>
            <img
              v-if="issue.publisher == 'Dark Horse'"
              src="https://d2lzb5v10mb0lj.cloudfront.net/darkhorse/index_images/blog/blog2015/sdcc15logo.jpg"
            />
            <img
              v-if="issue.publisher == 'Marvel'"
              width="300"
              src="https://logodownload.org/wp-content/uploads/2017/05/marvel-logo-0.png"
            />
            <img
              v-if="issue.publisher == 'DC'"
              width="300"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/DC_Comics_logo.svg/600px-DC_Comics_logo.svg.png"
            />
            <img
              v-if="issue.publisher == 'Centaur'"
              width="300"
              src="https://comicvine1.cbsistatic.com/uploads/scale_small/1/19772/619139-centaur.gif"
            />
            <img
              v-if="issue.publisher == 'Image'"
              width="300"
              src="https://static.wikia.nocookie.net/walkingdead/images/3/3f/Image-comics-logo.png/revision/latest?cb=20180904121918"
            />
            <img
              v-if="issue.publisher == 'IDW'"
              width="300"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/IDW_Publishing_logo.svg/300px-IDW_Publishing_logo.svg.png"
            />
            <img
              v-if="issue.publisher == 'Archie'"
              width="300"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Archiecomicslogo.png/800px-Archiecomicslogo.png"
            />
            <img
              v-if="issue.publisher == 'Boom!'"
              width="300"
              src="https://upload.wikimedia.org/wikipedia/en/e/ea/Updated_BOOM%21_logo%2C_fair_use.jpg"
            /></div
        ></b-col>
      </b-row>
    </b-container>
    <div class="summary">
      <h1 style="font-family: bebas neue">Synopsis</h1>
      <br />
